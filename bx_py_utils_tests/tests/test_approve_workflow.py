...
from bx_py_utils.test_utils.users import make_minimal_test_user
from bx_py_utils_tests.approve_workflow_test_app.models import ApproveTestModel, RelatedApproveTestModel
...
class BaseApproveModelTestCase(TestCase):
    ...
    def test_approve(self):
        ...
        with self.assertLogs('bx_py_utils', level=logging.WARNING) as logs:
        ...
        assert logs.output == [
            "WARNING:bx_py_utils.approve_workflow.models:Not ready to approve:"
        ...
        draft.blocked = True
        with self.assertLogs('bx_py_utils', level=logging.DEBUG) as logs:
        ...
        assert logs.output == [
            'DEBUG:bx_py_utils.approve_workflow.models:Approve <ApproveTestModel '
        ...
        with self.assertLogs('bx_py_utils', level=logging.INFO) as logs:
            approved = draft.approve()
        assert logs.output == [
            'INFO:bx_py_utils.approve_workflow.models:<ApproveTestModel '
        ...
        draft.ready_to_approve = True
        with self.assertLogs('bx_py_utils', level=logging.INFO):
            approved = draft.approve()
...
class BaseApproveModelAdminTestCase(HtmlAssertionMixin, TestCase):
    def test_approve(self):
        ...
        assert logs_output == [
            ...
            'INFO:bx_py_utils.approve_workflow.models:<RelatedApproveTestModel '
