...
* [`HtmlAssertionMixin()`](https://github.com/boxine/bx_django_utils/blob/master/bx_django_utils/test_utils/html_assertion.py#L5-L103) - Unittest mixin class with useful assertments around Django test client tests
